...
export const i = {
  ...
  keyboardInstructions: [
    ...
    "If you respond incorrectly, the screen will flash with a red color. ",
    "EOI",
  ],
  ...
  mismatchColorTextInstruction: [
    ...
    "Your job is to respond to the printed text. ",
    "I.e, 'green' is green ('G'-key) no matter the font color. ",
    "We begin with a warm up. ",
    "If you respond incorrectly, the screen will flash with a red color. ",
    "EOI",
  ],
  mismatchColorTextInstructionRepeat: [
    "Good job.",
    "Now, the actual test begins. ",
    "Remember, respond to the printed text. ",
    "EOI",
  ],
  mismatchColorValueInstruction: [
    "Well done.",
    "For the next trial, the text color and color name will still be different. ",
    "Your job this time is to respond with the correct font color. ",
    "I.e, only the color of the font matters. ",
    "We begin with a warm up. ",
    "EOI",
  ],
  mismatchColorValueInstructionRepeat: [
    "Good job.",
    "Now, the actual test begins. ",
    "Remember, respond to the color of the font. ",
    "EOI",
  ],
  endInstruction: [
